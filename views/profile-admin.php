    ...
    if (isset($_SESSION['id_petugas'])) {
        ...
        if (in_array($file_ext, $allowed_ext)) {
            if (move_uploaded_file($tmp_file, $path)) {
                ...
                header("Location: /bidcar/views/profile-admin.php");
            }
        } else {
                $_SESSION['flash'] = [
                'icon' => 'warning',
                'title' => 'Jenis file tidak diizinkan!',
                'text' => 'Hanya jpg,jpeg,png'
            ];
            header("Location: /bidcar/views/profile-admin.php");
            exit;
        }
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="profile-container">
            ...
            <div class="form-section">
                <div class="logo">
                    <img src="../img/bidcar alt color 3.svg" alt="Logo BidCar" style="height: 40px;">
                </div>
                <h2>Profile</h2>
...
Swal.fire({
    ...
    window.location.href = '/bidcar/model/admin/dashboard_admin.php'; 
});
</script>
<style>
.swal-font-custom,
