...
<body>
    ...
    <navbar class="navigasi">
        <div class="logo">
            ...
            <ul>
                <li><a href="/bidcar/model/masyarakat/index.php">Home</a></li>
        ...
        <div class="button-container">
            ...
            <img src="../../img/Login.svg" alt="Login Icon" class="icon"><a href="../../views/login.php">Masuk</a>
            </button>

            <button class="btn-kontak-kami">Kontak Kami <img src="../../img/phone icon.png" alt="Phone Icon" class="icon">
            </button>
        </div>
        </a>
    </navbar>
