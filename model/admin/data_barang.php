...
<head>
    ...
    <link rel="stylesheet" href="../../css/data_barang-admin.css">
</head>
<body>
        ...
        <div class="content-area"> 
            ...
            <div class="table-section"> 
                <div class="table-actions">
                    <a href="../admin/crud/tambah_barang.php"><button type="button" class="tambah-barang-btn"><img src="../../img/add-icon.svg" alt="tambah">Tambah Barang</button></a>
                    <a href="../../report/laporan_barang-admin.php"><button type="button" class="cetak-laporan-btn"><img src="../../img/cetak-icon.svg" alt="print">Cetak Laporan</button></a>
                                ...
                                <tr>
                                    ...
                                    <td class="col-action">
                                        <div class="action-buttons">
                                            <a href="../admin/crud/edit_barang.php?id_barang=<?= $row['id_barang']; ?>" class="action-btn edit-btn" title="Edit"><img src="../../img/edit-icon.svg" alt="edit"></a>
                                            <a href="../admin/crud/hapus_barang.php?id_barang=<?= $row['id_barang']; ?>" class="action-btn delete-btn" title="Hapus" onclick="return confirm('Yakin hapus data ini?')"><img src="../../img/hapus-icon.svg" alt="hapus"></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php } ?>
