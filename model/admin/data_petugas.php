        ...
        <div class="content">
            ...
            <div class="table-section">
                <div class="table-actions">
                    <button class ="tambah-petugas-btn" type ="button" name="tambah" ><a href="../admin/crud/tambah_petugas.php"><img src="../../img/add-icon.svg" alt="add">Tambah Petugas</a></button>
                    <a href="../../report/laporan_petugas.php"><button type="button" class="cetak-laporan-btn"><img src="../../img/cetak-icon.svg" alt="print">Cetak Laporan</button></a>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if ($status == 1) {
                                        echo '<span class="status-badge status-admin">Admin</span>';
                                    } elseif ($status == 2) {
                                        echo '<span class="status-badge status-petugas">Petugas</span>';
                                    } else {
                                        echo '-';
                                    }
                                    ?>
                                ...
                                <div class="action-buttons">
                                    <a href="../admin/crud/edit_petugas.php?id_petugas=<?php echo $row['id_petugas'];?>" class="action-btn edit-btn" title="Edit"><img src="../../img/edit-icon.svg" alt="edit"></a>
                                    <a href="../admin/crud/hapus_petugas.php?id_petugas=<?php echo $row['id_petugas'];?>" class="action-btn delete-btn" title="Hapus" onclick="return confirm('Yakin hapus data ini?')"><img src="../../img/hapus-icon.svg" alt="hapus"></a>
                                </div>
                                </td>
                            </tr>
                            <?php } ?>
